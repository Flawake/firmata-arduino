...
static const int ULTRASONE_MESSAGE =       0xA0; // ultrasone interface, set pins and read data
static const int SET_ULTRASONE_TRIG =      0x01; // ultrasone interface, set pins and read data
static const int SET_ULTRASONE_ECHO =      0x02; // ultrasone interface, set pins and read data
